...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalWidget.setMaximumSize(QtCore.QSize(1200, 90))
        self.horizontalWidget.setLayoutDirection(QtCore.Qt.RightToLeft)
        ...
        self.PantheraLogo = QtGui.QLabel(self.horizontalWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label.setPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/hsicon.ico")))
        ...
        self.pushButton_3 = QtGui.QPushButton(self.horizontalGroupBox1)
