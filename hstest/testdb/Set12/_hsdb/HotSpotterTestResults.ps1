...
$Labels = Import-Csv 30_Sets_Truth_Table.csv
...
$labels = $Labels | Where-Object {$_.HotSpotterCatName -ne $Null}

$labels | Export-Csv 30_Sets_Truth_Table_And_Hotspotter.csv -noType

$Results = Import-Csv 30_Sets_Truth_Table_And_Hotspotter.csv
...
$results | Export-Csv 30_Sets_Truth_Table_And_Hotspotter_Accuracy.csv -noType
